...
public class RenderPopGhost extends RenderPlayer
{
    public RenderPopGhost(RenderManager renderManager)
    {
        this(renderManager, false);
    }

    public RenderPopGhost(RenderManager renderManager, boolean useSmallArms)
    {
