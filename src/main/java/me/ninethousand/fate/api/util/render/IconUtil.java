...
public class IconUtil {
    public static void setWindowIcon() {
        if (Util.getOSType() != Util.EnumOS.OSX) {
            try (InputStream inputStream16x = Minecraft.class.getResourceAsStream("/assets/fate/logos/logo-16x.png");
                 InputStream inputStream32x = Minecraft.class.getResourceAsStream("/assets/fate/logos/logo-32x.png")) {
