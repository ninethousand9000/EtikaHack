...
import me.ninethousand.etikahack.api.util.misc.CustomTotemParticle;
...
public abstract class MixinParticleManager {
    ...
    private void registerVanillaParticles()
    {
        ...
        this.registerParticle(EnumParticleTypes.TOTEM.getParticleID(), new CustomTotemParticle.Factory());
    }

    @Shadow
    public abstract void registerParticle(int id, IParticleFactory particleFactory);
}
