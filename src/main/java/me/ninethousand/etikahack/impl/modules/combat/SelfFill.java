...
public class SelfFill extends Module {
    ...
    public void onUpdate() {
        ...
        if (findHotbarBlock(mode.getValue().clazz) == -1) {
            Command.sendClientMessageDefault("Can't find " + mode.getValue().clazz.getSimpleName().replaceFirst("Block", "") + " in hotbar!");
            disable();
            return;
        }
    ...
    public void faceVector(Vec3d vec, boolean normalizeAngle) {
