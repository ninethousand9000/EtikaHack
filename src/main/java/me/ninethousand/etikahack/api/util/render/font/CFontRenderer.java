...
public final class CFontRenderer {
    ...
    public CFontRenderer(String fontName, float fontSize) {
        name = fontName;
        size = fontSize;
        ...
        try {
            ...
            unicodeFont = new UnicodeFont(getFontByName(fontName).deriveFont(fontSize * prevScaleFactor / 2), (int) fontSize, true, false);
    ...
    public static Font getFontFromInput(String path) throws IOException, FontFormatException {
        font = Font.createFont(Font.TRUETYPE_FONT, CFontRenderer.class.getResourceAsStream(path));
