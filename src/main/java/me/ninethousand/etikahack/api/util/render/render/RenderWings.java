...
public class RenderWings extends ModelBase
{
    ...
    public RenderWings() {
        ...
        this.location = new ResourceLocation("textures/fate/wings/wings.png");
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event)
    {
        ...
        if (ModuleManager.getModule(DragonWings.class).isEnabled() && WingsUtil.usernames.contains(player.getName().toLowerCase()) && !player.isInvisible()) // Should render wings onto this player?
        {
    ...
    private void renderWings(EntityPlayer player, float partialTicks) {
        ...
        GL11.glColor3f(DragonWings.wingColor.getValue().getRed(), DragonWings.wingColor.getValue().getGreen(), DragonWings.wingColor.getValue().getBlue());
